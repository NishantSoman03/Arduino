...
// SD Card
#define SD_CS    15  // Chip select line for SD card module
...
void setup() {
  ...
  // Set VSPI pins for SD Card module
  vspi->beginTransaction(SPISettings(spiClk, MSBFIRST, SPI_MODE0));
  pinMode(SD_CS, OUTPUT);
  digitalWrite(SD_CS, HIGH); // Deselect the SD card initially

  // Set up slave select pins as outputs as the Arduino API doesn't handle automatically pulling SS low
  pinMode(vspi->pinSS(), OUTPUT); // VSPI SS
  pinMode(hspi->pinSS(), OUTPUT); // HSPI SS

  // Run the test functions for both SD card and Ethernet SPI
  runSDCardTests();
  runEthernetSPITests();
}
...
void runEthernetSPITests() {
  // Run the test functions for SPI Ethernet
